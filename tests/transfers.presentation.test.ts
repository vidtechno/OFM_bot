...
describe("transfer presentation",()=>{it("market narxini chiqaradi",()=>expect(formatMarket([player])).toContain("€100.0M"));it("listing tafsilotini chiqaradi",()=>expect(formatListing(player)).toContain("OVR 87"));});
