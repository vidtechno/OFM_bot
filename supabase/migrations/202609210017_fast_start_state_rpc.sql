-- ============================================================================
-- Phase 15: Fast Start State RPC (Single Round-trip User Upsert & Managed Clubs)
-- ============================================================================
...
BEGIN
  ...
  -- 2. Fast Managed Clubs Query in same transaction
  SELECT COALESCE(
    jsonb_agg(
      jsonb_build_object(
        'leagueClubId', lc.id,
...
GRANT EXECUTE ON FUNCTION public.get_user_start_state TO service_role;
